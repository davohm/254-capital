  ...
  return (
    <header className="bg-white w-full py-4 px-6 flex items-center justify-between shadow-sm">
      ...
      <nav className="hidden lg:flex items-center space-x-6">
        <div className="flex items-center text-darkgray relative">
          Demos
          <span className="absolute -top-1 -right-2 h-2 w-2 bg-softorange rounded-full"></span>
        </div>
        <div className="text-darkgray">Service</div>
        <div className="text-darkgray">Portfolio</div>
        <div className="text-darkgray">Blog</div>
        <div className="text-darkgray">Pages</div>
        <div className="text-darkgray">Shop</div>
        <div className="text-darkgray">Contact</div>
      </nav>
